...
var queryUrl = "/Bamboo2/Tornadoes_2000_2010_2020.csv";

d3.request("Bamboo2/Tornadoes_2000_2010_2020.csv")
  .mimeType("text/csv")
...
d3.csv(queryUrl, function(data) {
  ...
  L.geoJSON(data, {
    ...
    pointToLayer: function(BEGIN_LAT, BEGIN_LONG) {
      return new L.CircleMarker(d.BEGIN_LAT, d.BEGIN_LONG, {
        radius: circleRadius(d.MAGNITUDE),
        color: FScaleColor(d.TOR_F_SCALE), 
        fillOpacity: 0.85
      });
    }
...
legend.onAdd = function (myMap) {
    ...
    var div = L.DomUtil.create('div', 'info legend'),
        grades = ["EF0", "EF1", "EF2", "EF3", "EF4", "EF5"],
        labels = [];
